...
\section{Software and Programming}
  ...
  Recently, I have been using GPU acceleration with \textsc{jax}, and experimented with \textsc{rust}.
  ...
  I also took the lead in keeping my research group's various \textsc{python} packages up to date with the latest \textsc{python} versions and dependencies, mainly the sample post-processing package \textsc{anesthetic}.
