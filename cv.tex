...
\section{Teaching}
    ...
    \resumeItem
    {
      Through \nth{6} form, I assisted teaching year 7 music classes and after-school two-to-one sessions with year 10 and 11 students requiring extra help.
    }
    \resumeItemListEnd

\section{Software}
  \resumesubheading{Contributions}
    \resumeItemListStart
      \resumeItem{
        \href{https://pandas.pydata.org/docs/dev/whatsnew/v2.0.0.html}{pandas} and matplotlib
      }
...
\section{Research}
  ...
  \resumeSubheading
      {PhD Project: ``Bayesian methods in a flexible universe: sampling, }{Oct. 2021 -- present}
      \vspace{-10.5pt}
      \resumeSubheading{ tension and dark energy"}{Prof.~M.P.~Hobson, Dr.~W.J.~Handley, Prof.~A.N.~Lasenby}
      \resumeItemListStart
        \item[]
